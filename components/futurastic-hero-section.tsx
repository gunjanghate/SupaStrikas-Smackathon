  ...
  return (
    ...
    >
      <div className="relative z-10 flex flex-col items-center">
        <AnimatedShinyText className="inline-flex mt-4 items-center justify-center border-1 rounded-4xl px-4 py-1 transition text-neutral-400 ease-out hover:text-neutral-200 hover:duration-300 hover:dark:text-neutral-400">
        ...
        <motion.h1
          ...
          className="max-w-3xl font-sans bg-gradient-to-br from-white to-gray-400 bg-clip-text text-center text-3xl font-semibold leading-tight text-transparent sm:text-5xl sm:leading-tight md:text-7xl md:leading-tight"
        >
